...
public class SDKKitPlatformCollectionsImplWrapper {
	...
	public static void onEnterGame(final String roleId, final String roleName,
			final String roleLevel, final String serverId,
	...
	public static void onPay(final int amount, final String orderNumber,
	...
	public static void onCreateRole(final String roleId, final String roleName,
